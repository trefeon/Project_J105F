...
- `SHA256SUMS` (provenance: run 31519306192 @ 05c7b22a; .config re-shipped by the artifact-hidden-file fix run 31520084805): boot.img `a8603c2d2cab813c4a98b73c497206faf80ed83dca610ed31f9265afb4122a9b`; re-verified locally: all artifacts match CI hashes
  > **2026-08-14 refresh:** the flash bundle in `device/evidence/build-artifacts/kernel-m31/` was re-synced to the **gate-verified HEAD run 31524994372** (kernel_commit `f31f090a`, the 16 MiB gate commit — top-3 kernel commits are workflow-only, kernel source identical). boot.img is now `671a576a8ae95ce7d12bfa43ced679af4420d4591a7c6b920f404307df763a2e`, zImage `dc7dddc4…`, dt.img unchanged `f29f3d90…`; SHA256SUMS/BUILD_INFO in the bundle match the run exactly. Flash only `671a576a…`.
